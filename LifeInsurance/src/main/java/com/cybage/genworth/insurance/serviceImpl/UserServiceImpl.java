...
import com.cybage.genworth.insurance.exception.LifeInsuranceNotFoundException;
...
public class UserServiceImpl implements UserService {
	...
	public User loginUser(String username, String password) {
		...
		if (user == null) {
			throw new LifeInsuranceNotFoundException("You entered incorrect username.");
		} else {
			if (user.getUserpwd().equals(password)) {
				return user;
			}
			throw new LifeInsuranceNotFoundException("You entered incorrect password.");
		}
	}
